...
public interface IUserRepository
{
    ...
    public Task<string> GetOtpLoginByAsyn(ApplicationUserRolDto data);

    // public Task<TokenType> GetJWTTokenAsyn(ApplicationUserDto data);
    Task<ApplicationUserRolDto?> VerifyUser(string userName, string Password);
    Task<ApplicationUserRolDto?> GetUserdtoByNameAsync(string userName);
    ...
    Task<ApplicationUserRolDto> GetUserRoles(IUser user);
    ...
    public Task<List<Claim>> AddClaimForUser(ApplicationUserRolDto user);
